...
# Floating point numbers should be avoided if possible because decimals
# such as x.1 or x.3 are not exactly representable in a binary floating point number
...
numbers are similar to other languages in the way they are used and function.
'''
